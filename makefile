...
TESTS = ./tests/Test.o ./tests/Test2_GameObject.o ./tests/Test3_Batching.o
...
LOCAL = main.o WorldManager.o ImGuiManager.o Mesh.o Transform.o GameObject.o Batch.o BatchManager.o
